(function(r,o){typeof exports=="object"&&typeof module<"u"?o(exports,require("react"),require("styled-components")):typeof define=="function"&&define.amd?define(["exports","react","styled-components"],o):(r=typeof globalThis<"u"?globalThis:r||self,o(r["@srclaunch/themes"]={},r.React,r.styled))})(this,function(r,o,c){"use strict";var s=`html,
body,
#root {
...
`;const t={css:s,description:"Default AppLab Light theme",id:"applab-light",name:"AppLab Light"};var i=`html,
body,
#root {
  background-color: var(--bg-color-default);
...
`;const d={css:i,description:"AppLab dark theme",id:"applab-dark",name:"AppLab Dark"},h=o.memo(({className:e="",children:v,theme:g,themes:n})=>{const[a,b]=o.useState(n?.find(l=>l.id===g)??t);return o.useEffect(()=>{if(g&&n){const l=n.find(p=>p.id===g);b(l||t)}else b(t)},[g]),React.createElement("div",{className:`${a.id} ${e} theme-provider`,style:{display:"flex",flexGrow:1,overflow:"hidden"}},React.createElement(x,{theme:a}),v)}),x=c.createGlobalStyle`
  ${e=>e.theme.css};

`;r.AppLabDarkTheme=d,r.AppLabLightTheme=t,r.ThemeProvider=h,Object.defineProperties(r,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
