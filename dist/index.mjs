import r$1, { useContext, useRef, useLayoutEffect, createElement, memo, useState, useEffect } from 'react';
...
const ThemeProvider = memo(({
  ...
  const [currentTheme, setTheme] = useState(themes?.find((t) => t.id === theme) ?? AppLabLightTheme);
  useEffect(() => {
    if (theme && themes) {
